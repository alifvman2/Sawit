...
class CreateDataAsosiasi extends Migration
{
    use SoftDeletes;
    /**
     * Run the migrations.
    ...
    public function up()
    {
        Schema::create('data_asosiasi', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('izin_operasi')->nullable();
    ...
    {
        Schema::dropIfExists('data_asosiasi');
    }
}
