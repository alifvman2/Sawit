    ...
    <div class="mx-auto col-10 col-md-8 col-lg-8 py-5">
        <form class="py-5" method="POST" action="{{ route('register.custom') }}" autocomplete="off">
            ...
            <div class="form-group py-2">
                ...
                <input type="text" id="nama_lengkap" class="form-control form-control-lg transparent-input" name="nama_lengkap" required autocomplete="off" aria-autocomplete="none" autofocus />
            ...
            <div class="form-group py-2">
                ...
                <input type="email" id="email" class="form-control form-control-lg transparent-input" name="email" required autocomplete="off" aria-autocomplete="none" autofocus />
                @if ($errors->has('email'))
            ...
            <div class="form-group py-2">
                ...
                <input type="number" id="no_telp" class="form-control form-control-lg transparent-input" name="no_telp" required autocomplete="off" aria-autocomplete="none" autofocus />
            ...
            <button type="submit" class="col-12 btn btn-lg btn-block bg-dark-green white mt-5">Register</button>
